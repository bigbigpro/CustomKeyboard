...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ext.jiangxielin1/CustomKeyboard'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ext.jiangxielin1' => 'ext.jiangxielin1@jd.com' }
  s.source           = { :git => 'https://github.com/ext.jiangxielin1/CustomKeyboard.git', :tag => s.version.to_s }
